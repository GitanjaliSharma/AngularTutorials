...
let Ass1Component = class Ass1Component {
    constructor() {
        this.name = "John";
        this.phone = 3455;
    }
...
;
let Ass2Component = class Ass2Component {
    constructor() {
        this.typ = "password";
    }
    Show() {
...
let Directive1Component = class Directive1Component {
    constructor() {
...
let Directive2Component = class Directive2Component {
    constructor() {
        this.code = "DL";
    }
};
...
let TechDetailsComponent = class TechDetailsComponent {
    constructor() {
...
let InterpolationComponent = class InterpolationComponent {
    constructor() {
        this.city = "Pune";
        this.a = 10;
        this.b = 20;
...
let AreaCodePipe = class AreaCodePipe {
    transform(code) {
        switch (code) {
            case "12":
                return "Pune";
...
let NumToWordComponent = class NumToWordComponent {
};
...
let NumToWordPipe = class NumToWordPipe {
    transform(value) {
        switch (value) {
            case "1":
                return "One";
...
const routes = [{ path: "interpolation", component: _Interpolation_interpolation_component__WEBPACK_IMPORTED_MODULE_3__["InterpolationComponent"] },
